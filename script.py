'''
Date: 2021-09-12 18:58:35
LastEditors: Azus
LastEditTime: 2021-09-12 19:31:05
FilePath: /Py/script.py
'''
import selenium
# 方便延时加载
import time
...
browser.get('https://www.huazhu.com')
# 将窗口最大化
...
# browser.find_element_by_xpath("//*[@id='aw-login-user-password']").send_keys(
#     "密码")
# # 在输入用户名和密码之后,点击登陆按钮
